...
class GhrmUserGithubAccess(BaseModel):
    ...
    user_id = db.Column(db.UUID, db.ForeignKey("user.id", ondelete="CASCADE"), nullable=False, unique=True, index=True)
    ...
    access_status = db.Column(db.String(32), nullable=False, default=AccessStatus.ACTIVE)
